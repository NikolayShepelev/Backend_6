...
<body>
    ...
    <div class="container text-center">
        <div class="row mt-5">
            ...
            <div class="col">
                <div class="card bg-info text-white p-5" style="border-radius: 1rem;">
                    <a class="btn btn-outline-light" href="screenshots.html" role="button">Скриншоты</a>
                </div>

                <div class="card bg-info text-white my-4 my-md-5" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
        ...
        <?php if (!empty($superpower_id)) {
            ...
            <div class="container bg-info text-white mt-3">
