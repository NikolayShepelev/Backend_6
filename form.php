...
<body>
    <div class="w-100">
        <div class="container p-5 mb-2 text-white">
            <div class="row">
                <div class="col">
                    <a class="col btn btn-info btn-lg mt-4" href="admin.php" role="button">Админ</a>
                </div>
                ...
                <div class="col">
                    ...
                    if (!empty($_SESSION['login'])) {
                        ?><a class="col btn btn-info btn-lg mt-4" href="login.php" role="button">Выйти</a><?php
                    } else {
                        ?><a class="col btn btn-info btn-lg mt-4" href="login.php" role="button">Войти</a><?php
                    }
                    ?>
                </div>
            </div>
